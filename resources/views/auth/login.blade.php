...
<head>
    <title>Login | Toko Sembako Asui</title>
        ...
        <div class="vertical-align-wrap">
            <div class="vertical-align-middle">
                <div class="auth-box ">
                    ...
                    <div class="right">
                    <div class="right" style="background: url('{{ asset('assets/img/background.jpeg') }}') no-repeat center center; background-size: cover;">
                </div>
            </div>
        </div>
    </div>
